...
class MDataPreLoader(Dataset):
    ...
    def __getitem__(self, index):
        ...
        # video
        video_path = os.path.join(self.working_dir, 'Video/Segmented', video_id +'_'+ clip_id + '.mp4')
...
def parse_args():
    ...
    parser.add_argument('--working_dir', type=str, default='/media/dn/newdisk/datasets/CMU_MOSI/Raw/',
                        help='path to datasets')
    parser.add_argument('--language', type=str, default="en",
                        help='en / cn')
    parser.add_argument('--openface2Path', type=str, default="/media/dn/home/dn/下载/tools/OpenFace/build/bin/FeatureExtraction",
